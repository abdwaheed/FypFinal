 ...
 */}
      ...
      <section>
        <div className="aboutus-container text-center pt-5">
          <div className="row my-5">
            <h1>About <span className="word-color">Us</span></h1>
            <p>
              A Web Based E-Learning application is a platform that is an essential part of smart education. The main dare is to effortlessly incorporate the online learning method into the smart learning atmosphere according to the needs of students and provides many opportunities as compared to traditional learning.
              Online learning nowadays is one of the greatest source for the students to study. We are working on a web application for learning which will be totally free of cost for the courses that we will be providing. Users can get registered and enrolled in any course of their desire and after completing the course completely, user can also have certificate for that particular course.
            </p>
            <p>It is a project whose purpose is to educate common people practically and theoretically at large
              especially</p>
            ...
            <p>This net work is flourishing day by day and is becoming famous and familiar to people all over the world. The
              need of the day is that students demand an affliation of this net work services with some authorized
              govermental organization so that their certificates are authentic and can be verified.</p>
            <p>Insha Allah in near future you will be proud of our FYP team for our dedication and hard work.</p>

            <ul className="list-unstyled">
              <li>Cell # <strong style={{ color: "#FF0000" }}>0092 0336 326 5224</strong></li>
              <li>E-mail : whs@gmail.com</li>
